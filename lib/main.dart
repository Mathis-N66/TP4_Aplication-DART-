  ...
  Future<void> recuperer() async {
    ...
    if (idController.text != '') {
      try {
        ...
        Personne? Recuperee = await provider.getPersonne(int.parse(idController.text));
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return const AlertDialog(
                ...
                content: Text('Les données de la personne que vous recherchez ont été récupérées !'),
              );
            },
          );
        });
